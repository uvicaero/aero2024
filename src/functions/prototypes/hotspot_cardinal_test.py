...
def main():
    ...
    print("Press Enter to move North (5m)...")
    input()
    send_body_offset_local_position(the_connection, 5, 0, 0) # Allow time for movement
    ...
    print(f"Image 1 processed.\n")    

    send_body_offset_local_position(the_connection, -5, 0, 0)

    print("Press Enter to move East (5m)...")
    input()
    ...
    print(f"Image 2 processed.\n")   
    send_body_offset_local_position(the_connection, 0, -5, 0)

    print("Press Enter to move South (5m)...")
    input()
    send_body_offset_local_position(the_connection, -5, 0, 0)
    print("Press Enter to capture")
    input()
    ...
    print(f"Image 3 processed.\n") 
    send_body_offset_local_position(the_connection, 5, 0, 0)
    time.sleep(5)  # Allow time for movement

    print("Press Enter to move West (5m)...")
    input()
    send_body_offset_local_position(the_connection, 0, -5, 0)
    print("Press Enter to capture")
    input()
