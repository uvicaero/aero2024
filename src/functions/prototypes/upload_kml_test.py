...
def main():
    ...
    for marker_name, coords in coordinates_dict.items():
        kml.newpoint(name=f"Get GPS point {waypoint_count}", coords=[(coords['longitude'], coords['latitude'])])  # Lon, Lat
        waypoint_count += 1
    ...
    upload_kml('data/kml_source_files/hotspots.kml', 'https://drive.google.com/drive/folders/1GW56sU4zJuf8If8B6NgVultpZ_C2QT2V')
