...
def reposition_drone_over_hotspot(connection, image, pitch, fov_x=62.2, fov_y=48.8, image_width=3280, image_height=2464):
    """
    Detects a hotspot in the image, estimates its offset from the drone,
    and commands the drone to move to be directly over the hotspot.
    """
    ...
    send_body_offset_local_position(connection, x_offset, y_offset, 0)
...
def main():
    ...
    reposition_drone_over_hotspot(the_connection, image_gray, pitch)
